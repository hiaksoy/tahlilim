...
// rootNavigation bizim Admin / User Stack’i döndürüyor
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home">
        {/* 1) Login olmadan da kullanılacak ekranlar */}
        <Stack.Screen name="Home" component={HomeScreen} options={{ headerShown: false }} />
        <Stack.Screen name="Login" component={LoginScreen} />

        {/* 2) Login sonrasında AdminStack veya UserStack'e geçeceğimiz rota */}
        <Stack.Screen name="RootNav" component={RootNavigation} options={{ headerShown: false }} />
